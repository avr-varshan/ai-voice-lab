...
fp16 = False
def load_models(f0_condition=True,checkpoint="./runs/training_run/ft_model.pth",config="./configs/presets/config_dit_mel_seed_uvit_whisper_base_f0_44k.yml"):
...
@torch.no_grad()
def process_voice_conversion(models, source, target_name, output, f0_condition=True, auto_f0_adjust=True, pitch_shift=0, diffusion_steps=30, length_adjust=1.0,inference_cfg_rate=0.7):
